...
public class Main01 {
	...
	public static void main(String[] args) {
		...
		System.out.println("str2s_len : " + str2_len);
		System.out.println("---------------------------");
		...
		// 6. 문자열의 앞뒤 공백 제거
		String input = " enjoy    java  porgramming  ";
		...
		// 7. 문자열 비교하기
		boolean isSam = str1.equals(str2); // equals : 제시한 문자열이 같냐고 물어보는 것
		if (isSam) {
		...
		// - 첫 번째 파라미터 : 시작위치
		// - 두 번째 파라미터 : 끝 위치
		System.out.println("str1 : " + str1);	// 혹시 뒤쪽부터 출력은 안될까? -> 찾아보자
		String sub_str1 = str1.substring(0, 5);
